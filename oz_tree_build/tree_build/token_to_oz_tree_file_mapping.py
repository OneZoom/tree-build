...
token_to_file_map = {
    ...
    "POLYPTERIFORMES": {
        "file": "BicherSuzuki2010.phy",
        "edge_length": 353.4,
        "taxon": "Polypteriformes",
    },
    "ACIPENSERIFORMES": {
        "file": "SturgeonKrieger2008.phy",
        "edge_length": 166.1,
    ...
    "PALAEOGNATHAE": {
        "file": "PalaeognathaeMitchell2014.PHY",
        "edge_length": 40.45,
        "taxon": None,
    },
    "TINAMIFORMES": {
    ...
    "MARSUPIALIA": {
        "file": "Marsupial_recalibrated.phy",
        "edge_length": 73,
        "taxon": None,
    },
    "EUTHERIA": {
        "file": "PlacentalsPoulakakis2010.phy",
        "edge_length": 70,
        "taxon": None,
    },
    "BOREOEUTHERIA": {
        "file": "BoreoeutheriaOneZoom_altered.phy",
        "edge_length": 5,
        "taxon": None,
    },
    "XENARTHRA": {"file": "XenarthraOneZoom.phy", "edge_length": 17.8, "taxon": None},
    "AFROTHERIA": {
        "file": "AfrotheriaPoulakakis2010.phy",
        "edge_length": 4.9,
        "taxon": None,
    },
    ...
    "HYLOBATIDAE": {
        "file": "GibbonsCarbone2014.phy",
        "edge_length": 12.6,
        "taxon": None,
    },
    "DERMOPTERA": {
        "file": "DermopteraJanecka2008.phy",
        "edge_length": 55,
        "taxon": None,
    },
