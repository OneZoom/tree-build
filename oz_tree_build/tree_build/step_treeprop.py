...
GEOLOGICAL_PERIODS = [
    {"eon": "Unknown","era": "Unknown","period": "Unknown","epoch": "Unknown","short_text": "Unknown","long_text": "Unknown","color": "#1A1A1A","mya_start": -1e9,"number": 1},
...
def treeprop_sliding_window(tree, local_mean_width=5):
    """
...
def treeprop_weighted_mean(tree, weighting=0.8):
    """
