...
def test_start_string():
    assert run_get_matches("ab", 3) == [
        (0, "abcde"),
        (26, "xyzabcde"),
        (52, "xyzabcde"),
    ]
    assert run_get_matches("bc", 3) == [
        (1, "abcdef"),
        (27, "yzabcdef"),
        (53, "yzabcdef"),
    ]
...
def test_end_string():
    assert run_get_matches("yz", 3) == [
        (24, "vwxyzabc"),
        (50, "vwxyzabc"),
        (76, "vwxyz"),
    ]
    assert run_get_matches("xy", 3) == [
        (23, "uvwxyzab"),
        (49, "uvwxyzab"),
        (75, "uvwxyz"),
    ]
...
def test_overlap_string():
    ...
    assert run_get_matches("zabcdefgh", 3) == [
        (25, "wxyzabcdefghijk"),
        (51, "wxyzabcdefghijk"),
    ]
